...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <!--     Fonts and icons     -->
        ...
        <link href="{{ asset('material') }}/datepicker/bootstrap-datepicker.min.css" rel="stylesheet" />
    ...
    <body class="{{ $class ?? '' }}">
        ...
        <script src="{{ asset('material') }}/datepicker/bootstrap-datepicker.min.js"></script>
